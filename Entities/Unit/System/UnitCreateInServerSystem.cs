...
namespace Entities.Unit.System
{
    ...
    public partial class UnitCreateInServerSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            foreach (var (spawnUnitRPC,receiveRpc, entity)in SystemAPI.Query<RequestSpawnUnitRPC,ReceiveRpcCommandRequest>().WithEntityAccess())
            {
                ...
                LocalTransform localTransform = LocalTransform.FromPosition(spawnUnitRPC.Position);
