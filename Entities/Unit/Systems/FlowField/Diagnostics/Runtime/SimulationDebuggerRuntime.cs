...
public static class SimulationDebuggerRuntime
{
    ...
    public static ulong PublishedVersion => PublishedPublishedSimulationDiagnosticsRuntime.Generation;
        ...
        IncrementalContactPipelineSnapshot pipeline)
    {
        ...
        PublishedPublishedSimulationDiagnosticsRuntime.PublishComplete(snapshot, pipeline);
    ...
    {
        if (PublishedPublishedSimulationDiagnosticsRuntime.TryGetLatest(out PublishedSimulationDiagnosticsSnapshot unified))
        {
    ...
    public static void Reset()
    {
        ...
        PublishedPublishedSimulationDiagnosticsRuntime.Reset();
